...
| [ADR-020](ADR-020-automated-research-discovery.md) | Automated Research Discovery: Provider-Neutral Contract & Deterministic Mock (M7.1); Crossref Connector (M7.2 amendment) | Accepted (implemented) |
