...
| [ADR-020](ADR-020-automated-research-discovery.md) | Automated Research Discovery: Provider-Neutral Connector, Candidate-Only Output, Deferred Scheduler | Accepted (design; implementation NOT authorized) |
